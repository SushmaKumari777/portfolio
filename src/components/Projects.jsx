    ...
    <Section id="projects" eyebrow="Projects" title="Modern React Projects" revealFrom="bottom">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        {projects.map((project) => (
          ...
          <article
            key={project.title}
            className="group flex min-h-[300px] flex-col justify-between rounded border border-white/10 bg-iron p-6 shadow-hard transition duration-300 hover:border-blood-500"
          >
            <div>
