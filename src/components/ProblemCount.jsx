    ...
    <section className="relative z-10 mx-auto max-w-7xl px-5 py-16 sm:px-8">
      ...
      >
        ...
        {stats.map((stat, index) => (
          ...
          <motion.div
            key={index}
            className="group relative overflow-hidden rounded-lg border border-blood-500/30 bg-gradient-to-br from-blood-500/5 to-blood-600/5 p-8 backdrop-blur-sm transition-all duration-300 hover:border-blood-500"
