...
function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative z-10 mx-auto flex min-h-screen max-w-8xl items-center px-5 pb-20 pt-24 sm:px-8"
    >
      ...
      <div className="grid w-full items-center gap-14 lg:grid-cols-[1.08fr_0.92fr]">
        ...
        >
          ...
          <h1 className="mt-2 max-w-4xl text-4xl font-black leading-[0.98] sm:text-6xl lg:text-7xl">
            {profile.name}
            <span
              key={activeRoleIndex}
